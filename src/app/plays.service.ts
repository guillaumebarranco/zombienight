...
export class PlaysService {
    ...
    createPlay(play) {
        ...
        var requestoptions = new RequestOptions({
            url: "http://localhost/guillaume/zombienightapi/serveur.php?function=createPlay",
            headers: headers,
        ...
        return this.http.post("http://localhost/guillaume/zombienightapi/serveur.php?function=createPlay", play, requestoptions)
            .map((res:Response) => {
